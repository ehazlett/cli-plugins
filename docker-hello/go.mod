module github.com/ehazlett/cli-plugins/docker-hello

go 1.12

replace github.com/docker/distribution => github.com/docker/distribution v0.0.0-20190626020738-90dfea79523f

replace github.com/containerd/containerd => github.com/containerd/containerd v1.2.1-0.20190626153021-bb9616ba206c

replace github.com/docker/docker => github.com/docker/docker v0.7.3-0.20190626170757-a50869f077ea
...
require (
	...
	github.com/docker/cli v0.0.0-20190626100245-83aa71c45c0f
